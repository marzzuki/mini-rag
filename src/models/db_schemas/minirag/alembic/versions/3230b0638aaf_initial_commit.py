...
Revision ID: 3230b0638aaf
Revises: 
Create Date: 2025-10-01 20:03:03.556512
...
def upgrade() -> None:
    ...
    sa.Column('asset_config', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=False),
    ...
    op.create_index('ix_chunk_assets_id', 'chunks', ['chunk_asset_id'], unique=False)
